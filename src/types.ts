...
export type ExecutionLane =
  | "instant_rfq_atomic_fill"
  | "auction_discovery"
  | "auction_terms_to_instant_rfq_atomic_fill"
  | "auction_to_instant_rfq_atomic_fill"
  | "prefunded_create_buy"
  | "secondary_transfer";

export type PmGuarantee =
  | "guaranteed"
  | "not_applicable"
  | "not_guaranteed"
  | "conditional_registry_tracking";
...
export type RentReclaimKind =
  | "legacy_rfq"
  | "rfq_auction"
  | "rfq_maker_registry"
  | "combo_v2"
  | "option_collateral_lock";
