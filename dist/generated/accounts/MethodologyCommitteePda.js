...
exports.MethodologyCommitteePda = void 0;
const web3_js_1 = require("@solana/web3.js");
const bn_js_1 = __importDefault(require("bn.js")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
class MethodologyCommitteePda {
    constructor(fields) {
    ...
    static fromJSON(obj) {
        return new MethodologyCommitteePda({
            ...
            last_meeting_slot: new bn_js_1.default(obj.last_meeting_slot),
            next_decision_id: new bn_js_1.default(obj.next_decision_id),
            bump: obj.bump,
...
exports.MethodologyCommitteePda = MethodologyCommitteePda;
MethodologyCommitteePda.discriminator = Buffer.from([
    151, 5, 85, 192, 68, 123, 98, 57,
]);
MethodologyCommitteePda.layout = borsh.struct([
...
//# sourceMappingURL=MethodologyCommitteePda.js.map