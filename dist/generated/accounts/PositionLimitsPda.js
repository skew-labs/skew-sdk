...
exports.PositionLimitsPda = void 0;
const bn_js_1 = __importDefault(require("bn.js")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
class PositionLimitsPda {
    constructor(fields) {
    ...
    toJSON() {
        return {
            ...
            per_asset_short_limit_usd_micro: this.per_asset_short_limit_usd_micro.map((item) => item.toString()),
    ...
    static fromJSON(obj) {
        return new PositionLimitsPda({
            ...
            per_asset_short_limit_usd_micro: obj.per_asset_short_limit_usd_micro.map((item) => new bn_js_1.default(item)),
            last_updated_at: new bn_js_1.default(obj.last_updated_at),
            _reserved: obj._reserved,
        });
    }
}
exports.PositionLimitsPda = PositionLimitsPda;
PositionLimitsPda.discriminator = Buffer.from([
    135, 246, 73, 200, 208, 55, 147, 122,
]);
PositionLimitsPda.layout = borsh.struct([
    borsh.u8("bump"),
...
//# sourceMappingURL=PositionLimitsPda.js.map