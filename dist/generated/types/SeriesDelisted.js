...
class SeriesDelisted {
    ...
    static fromJSON(obj) {
        return new SeriesDelisted({
            ...
            direction: obj.direction,
            cumulative_fill_count: obj.cumulative_fill_count,
            delisted_at: new bn_js_1.default(obj.delisted_at),
        });
    }
    toEncodable() {
...
exports.SeriesDelisted = SeriesDelisted;
//# sourceMappingURL=SeriesDelisted.js.map