...
exports.TierDowngraded = void 0;
const web3_js_1 = require("@solana/web3.js"); // eslint-disable-line @typescript-eslint/no-unused-vars
const bn_js_1 = __importDefault(require("bn.js")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh"));
class TierDowngraded {
    constructor(fields) {
        this.cm = fields.cm;
    ...
    static fromJSON(obj) {
        return new TierDowngraded({
            ...
            released_collateral: new bn_js_1.default(obj.released_collateral),
            downgraded_at: new bn_js_1.default(obj.downgraded_at),
        });
    }
    toEncodable() {
...
exports.TierDowngraded = TierDowngraded;
//# sourceMappingURL=TierDowngraded.js.map