...
exports.adlStep = adlStep;
const web3_js_1 = require("@solana/web3.js"); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.layout = borsh.struct([borsh.u64("target_loss_micro")]);
function adlStep(args, accounts, programId = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const identifier = Buffer.from([157, 8, 214, 98, 60, 6, 241, 239]);
...
//# sourceMappingURL=adlStep.js.map