...
exports.layout = borsh.struct([borsh.array(borsh.u8(), 32, "label")]);
function registerBuilder(args, accounts, programId = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=registerBuilder.js.map