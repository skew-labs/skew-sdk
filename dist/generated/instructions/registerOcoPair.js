...
exports.registerOcoPair = registerOcoPair;
...
function registerOcoPair(args, accounts, programId = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const len = exports.layout.encode({
        ...
        take_profit: types.RegisterConditionalOrderArgs.toEncodable(args.take_profit),
    }, buffer);
    const data = Buffer.concat([identifier, buffer]).slice(0, 8 + len);
    const ix = new web3_js_1.TransactionInstruction({ keys, programId, data });
    return ix;
}
//# sourceMappingURL=registerOcoPair.js.map