...
exports.depositNativeSolCollateral = depositNativeSolCollateral;
const web3_js_1 = require("@solana/web3.js"); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.layout = borsh.struct([borsh.u64("amount")]);
function depositNativeSolCollateral(args, accounts, programId = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const identifier = Buffer.from([233, 191, 43, 164, 135, 59, 16, 55]);
...
//# sourceMappingURL=depositNativeSolCollateral.js.map