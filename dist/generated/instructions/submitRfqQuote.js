...
exports.submitRfqQuote = submitRfqQuote;
const web3_js_1 = require("@solana/web3.js"); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.layout = borsh.struct([types.SubmitRfqQuoteArgs.layout("args")]);
function submitRfqQuote(args, accounts, programId = programId_1.PROGRAM_ID) {
    const keys = [
...
//# sourceMappingURL=submitRfqQuote.js.map